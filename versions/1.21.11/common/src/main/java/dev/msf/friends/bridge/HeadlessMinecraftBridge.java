...
public final class HeadlessMinecraftBridge implements MinecraftBridge {
    ...
    @Override public void executeOnClientThread(Runnable r) {
        ...
        try {
            ...
            if (instance != null) {
                ...
                FabricReflect.mcMethod(mc, "execute", Runnable.class).invoke(instance, r);
                return;
            }
    ...
    public void acceptGuest(io.netty.channel.Channel rtcChannel, UUID guestProfileId) {
        ...
        try {
            ...
            FabricReflect.mcMethod(server.getClass(), "execute", Runnable.class).invoke(server, (Runnable) () -> {
                try {
    ...
    public static Optional<Snapshot> tryFetch() {
        ...
        try {
            ...
            try {
                ...
                // Fallback: try older method names (matches 26.1.2's invokeFirstString logic)
