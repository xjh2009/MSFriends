...
public class FriendsScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float a) {
        ...
        // Title
        graphics.drawCenteredString(this.font, TITLE, this.width / 2, 8, -1);
        if (this.statusMessage != null) {
            graphics.drawCenteredString(this.font, this.statusMessage, this.width / 2, 24, this.statusColor);
        }
        ...
        if (playerList != null && !playerList.children().isEmpty()) {
            ...
            graphics.drawCenteredString(this.font, empty, this.width / 2, (this.listTop() + this.listBottom()) / 2, -1);
        }
    }
    ...
    static abstract class BaseEntry extends ContainerObjectSelectionList.Entry<BaseEntry> {
        ...
        protected int renderBase(GuiGraphics g, int mouseX, int mouseY, float delta) {
            ...
            PlayerFaceRenderer.draw(g, skinGetter.get(), skinX, skinY, SKIN_SIZE);

            // Name
            int textX = skinX + SKIN_SIZE + 4;
            g.drawString(minecraft.font, playerName, textX, y + (h - minecraft.font.lineHeight) / 2, PLAYERNAME_COLOR);
    ...
    static class FriendEntry extends BaseEntry {
        ...
        @Override
        public void renderContent(GuiGraphics g, int w, int h, boolean hovered, float delta) {
            int x = this.getContentX();
            int y = this.getContentY();
            ...
            g.drawString(minecraft.font, playerName, textX, nameY, PLAYERNAME_COLOR);

            // Status (bottom half)
            if (status != null) {
                g.drawString(minecraft.font, status, textX, nameY + 12, statusColor);
            }
