...
public final class AcceptGuestBridge {
    ...
    public static void acceptGuest(Channel rtcChannel, UUID guestProfileId) throws Exception {
        ...
        Class<?> sclClass = Class.forName("net.minecraft.server.network.ServerConnectionListener");
        Class<?> handshakeListenerClass = Class.forName("net.minecraft.server.network.ServerHandshakePacketListenerImpl");
        ...
        Object server = minecraftClass.getMethod("getSingleplayerServer").invoke(minecraft);
        if (server == null) {
        ...
        Field sclField = minecraftServerClass.getDeclaredField("connection");
        ...
        List<Object> connections = (List<Object>) sclClass.getMethod("getConnections").invoke(scl);
        ...
        Method setListener = connectionClass.getMethod("setListenerForServerboundHandshake", packetListenerClass);
