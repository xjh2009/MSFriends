...
description = "MSF 1.19.2 adapter — version-specific code, loader-agnostic"

loom {
    // Enable mixin AP + refmap generation for Yarn-mapped versions.
    // Without refmap, Fabric can't remap Yarn method/field names to
    // intermediary at runtime, causing "No refMap loaded" errors.
