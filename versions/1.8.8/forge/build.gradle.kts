...
description = "MSF Forge 1.8.8 entry point"
...
dependencies {
    ...
    val forgeJar = forgeMavenizerRepo.file("net/minecraftforge/forge/1.8.9-11.15.1.2318-1.8.9/forge-1.8.9-11.15.1.2318-1.8.9.jar")
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("mcmod.info") { expand("version" to safeVersion, "mcversion" to "1.8.9") }
}

val forgeManifestAttrs = mapOf(
    "Specification-Title" to "MSF-forge-1.8.8",
    "Specification-Version" to project.version,
    "Implementation-Title" to "MSF-forge-1.8.8",
    "Implementation-Version" to project.version,
    "FMLCorePlugin" to "dev.msf.friends.MsfFriendsLoadingPlugin",
