...
/**
 * MinecraftBridge for Forge 1.9.4.
 * Java 8 compatible. Uses MC 1.9.4 API: Minecraft.getMinecraft(), Session, etc.
 *
 * MC 1.9.4 differences from 1.8.9:
 * - Text classes moved to net.minecraft.util.text
        ...
        try {
            ...
            if (mc != null && mc.thePlayer != null) {
                TextComponentString text = new TextComponentString(
                        TextFormatting.GREEN + "[MSF Friends] " + TextFormatting.RESET + message);
