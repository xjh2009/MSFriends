...
description = "MSF Forge 1.9.4 entry point"

minecraft {
    mappings("snapshot", "stable_22")
...
dependencies {
    ...
    implementation(minecraft.dependency("net.minecraftforge:forge:1.9.4-12.17.0.2317-1.9.4"))

    val forgeMavenizerRepo = rootProject.layout.projectDirectory.dir(".gradle/mavenizer/repo")
    val forgeJar = forgeMavenizerRepo.file("net/minecraftforge/forge/1.9.4-12.17.0.2317-1.9.4/forge-1.9.4-12.17.0.2317-1.9.4.jar")
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("mcmod.info") { expand("version" to safeVersion, "mcversion" to "1.9.4") }
}

val forgeManifestAttrs = mapOf(
    "Specification-Title" to "MSF-forge-1.9.4",
    "Specification-Version" to project.version,
    "Implementation-Title" to "MSF-forge-1.9.4",
