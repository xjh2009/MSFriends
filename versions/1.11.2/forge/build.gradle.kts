...
description = "MSF Forge 1.11.2 entry point"

minecraft {
    mappings("snapshot", "stable_32")
...
dependencies {
    ...
    val forgeJar = forgeMavenizerRepo.file("net/minecraftforge/forge/1.11.2-13.20.1.2588/forge-1.11.2-13.20.1.2588.jar")
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("mcmod.info") { expand("version" to safeVersion, "mcversion" to "1.11.2") }
}

val forgeManifestAttrs = mapOf(
    "Specification-Title" to "MSF-forge-1.11.2",
    "Specification-Version" to project.version,
    "Implementation-Title" to "MSF-forge-1.11.2",
