...
/**
 * Main entry point for the MSF Friends mod on Forge 1.8.9.
...
public class MsfFriendsBoot {
    ...
    public void init(FMLInitializationEvent event) {
        MsfFriendsConstants.logLifecycle("init — booting (self-contained 1.8.9)");
        ...
        new Thread(() -> {
            try {
                ...
                LOGGER.info("[MSF/Friends] Mod initialised (simplified 1.8.9 build).");
            } catch (Exception e) {
