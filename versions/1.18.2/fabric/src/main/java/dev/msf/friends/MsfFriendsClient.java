...
public final class MsfFriendsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        INSTANCE = this;
        // Key binding is registered via OptionsMixin (appends to Options.keyMappings array)
        // and the in-game O-key handler is in KeyBindingMixin (injects into Minecraft.tick).
        ...
        LOGGER.info("[boot] Fabric entry point, starting boot");
