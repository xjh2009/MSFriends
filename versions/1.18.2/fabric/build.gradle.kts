...
description = "MSF Fabric 1.18.2 entry point"
...
dependencies {
    ...
    implementation(libs.fabric.loader1182)
    implementation(libs.fabric.api1182)
...
tasks.named<Jar>("jar") {
    ...
    manifest {
        attributes(
            "Specification-Title" to "MSF-fabric-1.18.2",
            "Specification-Version" to project.version,
            "Implementation-Title" to "MSF-fabric-1.18.2",
