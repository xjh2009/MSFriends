...
public final class ForgeReflect {
    ...
    private static final Map<String, String> CLASS_MAP = Map.ofEntries(
            ...
            Map.entry("net.minecraft.client.gui.GuiScreen",                           "net.minecraft.client.gui.GuiScreen"),
            Map.entry("net.minecraft.client.gui.GuiMainMenu",                         "net.minecraft.client.gui.GuiMainMenu"),
            Map.entry("net.minecraft.client.gui.GuiIngameMenu",                       "net.minecraft.client.gui.GuiIngameMenu"),
            Map.entry("net.minecraft.client.gui.GuiShareToLan",                       "net.minecraft.client.gui.GuiShareToLan"),
            Map.entry("net.minecraft.client.gui.GuiButton",                           "net.minecraft.client.gui.GuiButton"),
            Map.entry("net.minecraft.client.gui.GuiTextField",                        "net.minecraft.client.gui.GuiTextField"),
            Map.entry("net.minecraft.network.NetworkManager",                         "net.minecraft.network.NetworkManager"),
            Map.entry("net.minecraft.network.login.client.CPacketLoginStart",         "net.minecraft.network.login.client.CPacketLoginStart"),
            Map.entry("net.minecraft.client.network.NetHandlerLoginClient",           "net.minecraft.client.network.NetHandlerLoginClient"),
            Map.entry("net.minecraft.network.NetHandlerLoginServer",                  "net.minecraft.network.NetHandlerLoginServer"),
    ...
    private static final Map<String, String> METHOD_MAP = Map.ofEntries(
            ...
            Map.entry("net.minecraft.network.NetHandlerLoginServer.tryAcceptPlayer",   "func_147326_c"),
    ...
    private static final Map<String, String> FIELD_MAP = Map.ofEntries(
            ...
            Map.entry("net.minecraft.network.NetHandlerLoginServer.networkManager",    "field_147333_a"),
            Map.entry("net.minecraft.network.NetHandlerLoginServer.server",            "field_147334_b"),
            Map.entry("net.minecraft.network.NetHandlerLoginServer.loginGameProfile",  "field_147337_i")
    );
