...
/**
 * Client-side bridge for MC 1.13.2 Forge: wires an RtcChannel into MC's
...
public final class ConnectionBridge {
    ...
    public static void joinHost(Channel rtcChannel, String playerName, UUID profileId) throws Exception {
        ...
        Class<?> clientHandshakeClass = ForgeReflect.mcClass("net.minecraft.client.network.NetHandlerLoginClient");
        Class<?> helloPacketClass = ForgeReflect.mcClass("net.minecraft.network.login.client.CPacketLoginStart");
        ...
        try {
            ...
            if (worldField.get(minecraft) != null) {
                ...
                try {
                    Class<?> worldClientClass = Class.forName("net.minecraft.client.multiplayer.WorldClient");
                    minecraftClass.getMethod("loadWorld", worldClientClass).invoke(minecraft, (Object) null);
                } catch (Exception e2) {
