 ...
 *
 * 1.20.1 Yarn: ClientHandshakePacketListenerImpl → ClientLoginNetworkHandler,
 * Connection → ClientConnection.
 *
 * Yarn names used for @Shadow; refmap handles runtime intermediary remapping.
 * method_2893 is unmapped (private encryption setup) — uses remap=false.
 */
