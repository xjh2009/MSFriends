...
description = "MSF Forge 1.12.2 entry point"

minecraft {
    mappings("snapshot", "snapshot_20171003")
...
dependencies {
    ...
    implementation(minecraft.dependency("net.minecraftforge:forge:1.12.2-14.23.5.2860"))

    val forgeMavenizerRepo = rootProject.layout.projectDirectory.dir(".gradle/mavenizer/repo")
    val forgeJar = forgeMavenizerRepo.file("net/minecraftforge/forge/1.12.2-14.23.5.2860/forge-1.12.2-14.23.5.2860.jar")
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("mcmod.info") { expand("version" to safeVersion, "mcversion" to "1.12.2") }
}

val forgeManifestAttrs = mapOf(
    "Specification-Title" to "MSF-forge-1.12.2",
    "Specification-Version" to project.version,
    "Implementation-Title" to "MSF-forge-1.12.2",
