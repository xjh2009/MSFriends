...
description = "MSF Fabric 1.17.1 entry point"
...
dependencies {
    ...
    implementation(libs.fabric.loader1171)
    implementation(libs.fabric.api1171)
...
tasks.named<Jar>("jar") {
    ...
    from(commonJar.map { zipTree(it.archiveFile) }) {
        ...
        // Exclude classes provided by authlib 3.x (MC 1.17.1 runtime)
    ...
    manifest {
        attributes(
            "Specification-Title" to "MSF-fabric-1.17.1",
            "Specification-Version" to project.version,
            "Implementation-Title" to "MSF-fabric-1.17.1",
