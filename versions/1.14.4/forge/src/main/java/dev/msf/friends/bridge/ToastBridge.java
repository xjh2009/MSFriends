...
/**
 * Bridges toast notifications for MC 1.14.4 Forge.
 *
 * <p>1.13.2 MCP: uses {@link TranslationTextComponent} (equivalent of
...
public final class ToastBridge {
    ...
    private static ITextComponent getTitleForType(String type) {
        return new TranslationTextComponent("toast.msf_friends." + type + ".title");
    }
    ...
    private static ITextComponent getDescriptionForType(String type, String name) {
        switch (type) {
            ...
            case "friend.action.failed":
                return new TranslationTextComponent("toast.msf_friends." + type + ".description");
            default:
                return new TranslationTextComponent("toast.msf_friends." + type + ".description", name);
        }
    }
