...
description = "MSF 1.16.5 adapter — version-specific code, loader-agnostic"

loom {
    // Enable mixin AP + refmap generation for Yarn-mapped versions.
    // Without refmap, Fabric can't remap Yarn method names to intermediary
    // at runtime, causing "No refMap loaded" errors.
...
dependencies {
    ...
    compileOnlyApi(libs.fabric.loader1165)
